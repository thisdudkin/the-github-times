...
public interface NewspaperService {
    ...
    Collection<Article> findArticlesByTagName(String tagName) throws DataAccessException;
    Collection<Article> findArticlesByKeyword(String keyword) throws DataAccessException;
    Collection<Article> findArticlesByCategoryName(String categoryName) throws DataAccessException;
